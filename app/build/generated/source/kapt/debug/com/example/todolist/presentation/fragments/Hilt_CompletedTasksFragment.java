...
public abstract class Hilt_CompletedTasksFragment extends ParentFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CompletedTasksFragment_GeneratedInjector) this.generatedComponent()).injectCompletedTasksFragment(UnsafeCasts.<CompletedTasksFragment>unsafeCast(this));
    }
  }
