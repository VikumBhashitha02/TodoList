...
public abstract class Hilt_TaskCategoryFragment extends ParentFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TaskCategoryFragment_GeneratedInjector) this.generatedComponent()).injectTaskCategoryFragment(UnsafeCasts.<TaskCategoryFragment>unsafeCast(this));
    }
  }
