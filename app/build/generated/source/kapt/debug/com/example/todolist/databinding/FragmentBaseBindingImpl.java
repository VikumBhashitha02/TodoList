...
public class FragmentBaseBindingImpl extends FragmentBaseBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.categoryText, 1);
        sViewsWithIds.put(R.id.categoriesRecyclerView, 2);
        sViewsWithIds.put(R.id.categoryAnimationView, 3);
        sViewsWithIds.put(R.id.tasksText, 4);
        sViewsWithIds.put(R.id.tasksRecyclerView, 5);
        sViewsWithIds.put(R.id.noResultAnimationView, 6);
